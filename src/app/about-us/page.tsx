  ...
  return (
    <div>
      <div className="t mx-auto ">
        <div className="relative h-96  bg-blend-multiply bg-opacity-60  bg-black bg-right-bottom">
          ...
          <h2 className="md:text-7xl text-white absolute translate left-1/2 -translate-x-1/2 -translate-y-1/2 top-1/2 text-center  text-white font-medium text-5xl md:pt-6 py-2">
            About Us
          </h2>
        </div>
